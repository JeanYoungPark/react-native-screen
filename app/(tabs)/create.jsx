            ...
            <ScrollView className='px-4 my-6'>
                ...
                <View className='mt-7 space-y-2'>
                    ...
                    <TouchableOpacity onPress={() => openPicker("video")}>
                        {form.video ? (
                            ...
                            <View className='w-full h-40 bg-black-100 px-4 justify-center items-center rounded-2xl'>
                ...
                <View className='mt-7 space-y-2'>
                    ...
                    <TouchableOpacity onPress={() => openPicker("image")}>
                        {form.thumbnail ? (
                            <Image source={{ uri: form.thumbnail.uri }} resizeMode='cover' className='w-full h-64 rounded-xl' />
                        ) : (
                            <View className='w-full h-16 bg-black-100 px-4 justify-center items-center rounded-2xl borer-2 border-black-200 flex-row space-x-2'>
